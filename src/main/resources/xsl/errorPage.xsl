      ...
      <div class="col-md-8" lang="de">
        <xsl:choose>
          ...
          <xsl:when test="/mcr_error/@HttpError = '404'">
              ...
              schreiben Sie eine Mail an <span class="madress">bibliothek [at] leopoldina.org</span> und
          ...
          <xsl:when test="/mcr_error/@HttpError = '403'">
              ...
              schreiben Sie eine Mail an <span class="madress">bibliothek [at] leopoldina.org</span>.
              <br/><br/>
              Vielen Dank!</p>
          </xsl:when>
          <xsl:otherwise>
